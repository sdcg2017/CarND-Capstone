...
#>> Nianfeng: generate new lane and publish

    def publish_waypoints(self):
        final_lane = self.generate_lane()
        self.final_waypoints_pub.publish(final_lane)

#>> Nianfeng: Added function to generate lane
    ...
    def generate_lane(self):
        ...
        return lane
#>> Nianfeng: Added function to generate decelerate waypoints
